    ...
    return (
        <div className="auth_page">
            <form onSubmit={handleSubmit}>
                <h3 className="text-uppercase text-center mb-4"><img class="logoappwe"src="https://res.cloudinary.com/tdtuniversity/image/upload/v1621373643/logo_icon_kk5xsr.png"></img></h3>
